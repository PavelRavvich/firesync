...
from firesync.workspace import (CONFIG_DIR_NAME, CONFIG_FILE_NAME,
                                ...
                                find_config, init_workspace, load_config)
...
class TestEnvironmentConfig(unittest.TestCase):
    ...
    def test_valid_with_key_env(self):
        ...
        env = EnvironmentConfig(name="staging", key_env="GCP_STAGING_KEY")
    ...
    def test_both_key_file_and_key_env_raises_error(self):
        ...
        with self.assertRaises(ValueError) as ctx:
            EnvironmentConfig(
                name="invalid", key_file="keys/prod.json", key_env="GCP_KEY"
            )
...
class TestWorkspaceConfig(unittest.TestCase):
    ...
    def test_config_dir_property(self):
        ...
        self.assertEqual(self.config.config_dir, Path("/project/firestore-migration"))
    ...
    def test_get_schema_dir(self):
        ...
        self.assertEqual(schema_dir, Path("/project/firestore-migration/schemas/prod"))
